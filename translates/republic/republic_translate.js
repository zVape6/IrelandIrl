...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const texts = {
        ru: {
            ...
            best_places3: "Лучшие места: Латинский квартал, набережная Салта-Хилл, фестивали, паб-культура",
        ...
        en: {
            ...
            best_places3: "Top attractions: Latin Quarter, Salt Hill Promenade, Festivals, Pub Culture",
